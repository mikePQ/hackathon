...
import org.cos.sie.popsulo.download.enums.States;
import org.cos.sie.popsulo.download.exceptions.DownloadEmptyTitle;
import org.cos.sie.popsulo.download.exceptions.DownloadFatal;
...
public class VGet {
    ...
    /**
     * @return return status of download information. subclassing for VideoResult.empty();
     * 
     */
